...
std::map <std::string, std::string> tipsActionsENG = {
	...
	{ "9", "Establishes the number of item"},
	{ "10", "Starts the loadtriggers" },
	{ "11", "Spawn an npc in some location looking at something with some kind of animation" },
	{ "12", "Create a link" },
	{ "13", "Replace the npc`s state" },
	{ "14", "Actvates the trigger" },
	{ "15", "Teleports the object to something and turns it" },
	{ "16", "Change HP of the npc" },
	{ "17", "Spawns a pickup in some quantity" },
	{ "18", "Displays a window with the text" },
	{ "19", "Finished the level" },
	{ "20", "Activates the cutscene" },
	{ "21", "Replaces the cutscene at the npc" },
	{ "22", "Issues a quest" },
	...
	{ "51", "Hide/snow objects at the npc"},
...
std::map <std::string, std::string> tipsActionsRUS = {
	...
	{ "12", (const char*)u8"Создает ссылку" },
